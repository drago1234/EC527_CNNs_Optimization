...
int main(int argc, char *argv[])
{
	...
	printf("1(1D single block) --> 2(1D multi-block) --> 3(1D mulit-block with mask in constant memory) --> 4(tiled algo with Strategy 1) --> 5(1D tiled strategy 1) --> 6(1D tiled strategy 2)\n");
	switch (taskid){
	case 1:
