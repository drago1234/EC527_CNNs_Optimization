...
double interval_main(struct timespec start, struct timespec end)
{
...
int main(int argc, char** argv) {
    ...
    double* time_stamp = (double*)calloc(TestTimes, sizeof(double));
    ...
    */
    ...
    time_stamp[0] = time_stamp[0] + interval_main(time_start, time_stop);
    printf("train time = %f", time_stamp[0]);
    ...
    printf("Classifying:\n");
    printf("------------\n");
    mlp_classifier(param, layer_sizes, time_stamp, TestTimes);
    //printf("mat_mul_time0 = %f; mat_mul_time1 = %f", time_stamp[0], time_stamp[1]);
